...
\begin{equation}
  \frac{D\vort_p}{Dt} =
    \nu\e^{-2}\sum_q v_q [\vort_q - \vort_p] \eta_\e(\x_p - \x_q),
\end{equation}
with a proper choice of a spherically symmetric function~\(\eta\).
...
Kinematic boundary conditions can be expressed as an aditional term
...
and their core sizes~\(\e\) can be made to be variable.

These techniques will be not taken into account in this work.
