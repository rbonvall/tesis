...
\begin{figure}
  ...
  \tikzstyle{ctrl}=[fill=green!30]
  %\tikzstyle{alu}=[fill=red!80!black!40]
  \tikzstyle{alu}=[pattern color=red!80!black!40, pattern=north east lines]
  \tikzstyle{cache}=[fill=blue!30]
  \tikzstyle{dram}=[fill=blue!30]
  \subfigure[CPU] {
  ...
  \subfigure[GPU] {
    \begin{tikzpicture}[scale=0.8]
      ...
      \foreach \y in {2.25, 2.75, ..., 6}
        \draw[cache] (0, \y) rectangle +(0.5, -0.25);
    \end{tikzpicture}
  }
